	...
	<div class="sidebar" :class="{sidebarie:isIE}">
		<div>
			<div @mouseover="onInfoMouseOver($event)">
				<i>
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						viewBox="0 0 724 642" style="enable-background:new 0 0 724 642;" xml:space="preserve">
						<path class="st0" d="M639.6,496.6H227.2c-1.3,0-2.6,0.5-3.5,1.4L112.7,609.4c-1,1-2.7,0.3-2.7-1.1V501.5c0-2.7-2.2-4.9-4.9-4.9H84.4
			...
			<div @click="$store.state.dialogVisible=true" @mouseover="onPrizeMouseOver($event)">
				<i>
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						...
						<path class="st1" d="M484.6,97.5H441V40.6h-57.4C360.4,15.4,325,0.7,286.5,0.7s-73.8,14.7-97.2,39.9h-57.8v56.9H89.4
			...
			<div @click="$store.state.dialogDesign.design=true" @mouseover="onDesignMouseOver($event)">
				<i>
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						viewBox="0 0 710 1100" style="enable-background:new 0 0 710 1100;" xml:space="preserve">
						<path class="st0 ruler" d="M4,856v223.6c0,11.4,9.2,20.6,20.6,20.6h660.7c5.5,0,10.7-2.2,14.6-6c3.8-3.8,6.1-9.1,6-14.6V856.1
						...
						<path class="st0 pencil" d="M696.6,496.6l-112.2-89.2c-10.7-8.5-26.2-6.7-34.7,4L385,618.2c-2.3,2.9-4,6.4-4.8,10l-29.8,134.1
...
export default class sidebar extends Vue {
	...
	onDesignMouseOver(event: MouseEvent) {
		...
		this.designTween = gsap.timeline()
			.add(gsap.to(pencil, {
				duration: 0.1,
				x: -280,
				y: -374
		...
		div {
			...
			&:nth-child(1) {
				i {
					width: 23px;
					height: 20px;
					.st0{fill:none;stroke:#FFFFFF;stroke-width:61.3882;stroke-miterlimit:10;}
					.st1{fill:#FFFFFF;}
				}
			}
			&:nth-child(2) {
